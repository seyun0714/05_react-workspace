  ...
  return (
    <div>
      <nav>
        ...
        <Link to="/profile/1">1번회원프로필페이지</Link>|
        <Link to="/profile/2">2번회원프로필페이지</Link>|
        <Link to="/practice/it/3">연습 it 3번 페이지</Link>|
      </nav>
      <main>
        <Routes>
          ...
          <Route path="/practice/:category/:id" element={<Practice />}></Route>
        </Routes>
      </main>
    </div>
  );
