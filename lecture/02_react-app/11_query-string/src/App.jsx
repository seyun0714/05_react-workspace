...
/*
  * 동적 세그먼트와 쿼리 스트링의 차이
  1. 동적 세그먼트 - /info/홍길동/20
    ...
    4) 라우터 정의하는 곳에 :id, :userId 처럼 세그먼트를 예약어 처리
    5) 컴포넌트 측에서 useParams() 훅을 통해 세그먼트 값 가져올 수 있음

  2. 쿼리 스트링 - /ino?name=홍길동&age=20
    1) URL의 끝의 ? 뒷부분에 여러 정보를 key=value 쌍으로 전달
    2) 주로 필터링, 검색어, 정렬, 분기처리 등 페이지 표시/동작 옵션을 넘길 때 사용
